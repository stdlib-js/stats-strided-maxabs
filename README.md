...
```javascript
maxabs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-maxabs@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-strided-maxabs/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-maxabs/actions/workflows/test.yml?query=branch:v0.1.1
